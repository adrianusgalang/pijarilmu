    ...
    <header id="header" class="header">
        <div class="container">
            ...
            <nav class="navigation">
                ...
                <!-- MENU -->
                <ul class="menu">
                    <li class="current-menu-item"><a href="home">Halaman Utama</a></li>
                    <li class="menu-item-has-children megamenu col-3">
                        <a>Menu</a>
                        <!--<ul class="sub-menu">
					...
					<li class="menu-item-has-children">
                        <a href="">Jenjang</a>
                        <ul class="sub-menu">
                            <li><a href="categories?mapel=0&jenjang=1">Sekolah Dasar(SD) Sederajat</a></li>
							<li><a href="categories?mapel=0&jenjang=2">Sekolah Menengah Pertama(SMP) Sederajat</a></li>
							<li><a href="categories?mapel=0&jenjang=3">Sekolah Menengah Atas(SMA) Sederajat</a></li>
							<li><a href="categories?mapel=0&jenjang=4">Umum</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children megamenu col-4">
                        ...
                        <ul class="sub-menu">
                            <li class="menu-item-has-children">
                                <a>Sekolah Dasar(SD) Sederajat</a>
                                <ul class="sub-menu">
									@forelse($data['mapelSd'] as $key => $value)
                                    <li><a href="categories?mapel={{ $value->id_mapel }}&jenjang=1">{{ $value->mapel }}</a></li>
									@empty
									<p>Tidak ada data</p>
									@endforelse
                                </ul>
                            ...
                            <li class="menu-item-has-children">
                                <a>Sekolah Menengah Pertama(SMP) Sederajat</a>
                                <ul class="sub-menu">
                                    @forelse($data['mapelSmp'] as $key => $value)
                                    <li><a href="categories?mapel={{ $value->id_mapel }}&jenjang=2">{{ $value->mapel }}</a></li>
									@empty
									<p>Tidak ada data</p>
									@endforelse
                                </ul>
                            ...
                            <li class="menu-item-has-children">
                                <a>Sekolah Menengah Atas(SMA) Sederajat</a>
                                <ul class="sub-menu">
                                    @forelse($data['mapelSma'] as $key => $value)
                                    <li><a href="categories?mapel={{ $value->id_mapel }}&jenjang=3">{{ $value->mapel }}</a></li>
									@empty
									<p>Tidak ada data</p>
									@endforelse
                                </ul>
							...
							<li class="menu-item-has-children">
                                <a>Umum</a>
                                <ul class="sub-menu">
                                    @forelse($data['mapelUmum'] as $key => $value)
                                    <li><a href="categories?mapel={{ $value->id_mapel }}&jenjang=4">{{ $value->mapel }}</a></li>
									@empty
									<p>Tidak ada data</p>
									@endforelse
                                </ul>
